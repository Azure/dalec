...
- **Documentation:**
  - `make docs-serve` - Build and run the documentation server with Hugo
...
5. Update documentation in `website/content/`
...
# Edit files in website/content/ and restart to rebuild
```
