...
func handleDeb(ctx context.Context, client gwclient.Client, spec *dalec.Spec) (gwclient.Reference, *dalec.DockerImageSpec, error) {
...
func workerImg(sOpt dalec.SourceOpts) llb.State {
	...
	return llb.Image(jammyRef, llb.WithMetaResolver(sOpt.Resolver)).
		Run(
