...
const StepRunnerCmdName = "test-steprunner"
...
func WithTestStep(frontend llb.State, step *dalec.TestStep, index int, outputPath string) llb.RunOption {
	return dalec.RunOptFunc(func(ei *llb.ExecInfo) {
		...
		const testRunnerPath = "/tmp/dalec/internal/frontend/test-runner"
		...
		const testStepPath = "/tmp/dalec/internal/frontend/test/step.json"
